    ...
    <footer className="footer">
      <div className="container footer-top">
        <div>
          ...
          <p>Trải nghiệm đặt vé điện ảnh hiện đại, trực quan và an toàn.</p>
        </div>
        <div className="footer-cta">
          <strong>Đặt vé cho buổi xem tiếp theo</strong>
          <Link className="btn btn-sm" to="/movies">
            Khám phá phim
          </Link>
        </div>
      </div>
      <div className="container footer-grid">
        ...
        <div>
          ...
          <span>CI/CD & Docker ready</span>
        </div>
      </div>
      <div className="container footer-bottom">
        © 2026 CineVerse · Software Engineering Portfolio Project
      </div>
    </footer>
  );
}
